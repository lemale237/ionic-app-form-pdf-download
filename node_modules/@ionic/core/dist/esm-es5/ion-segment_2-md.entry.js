...
import { r as registerInstance, d as createEvent, w as writeTask, h, H as Host, e as getElement } from './index-e23c3ffd.js';
...
var SegmentButton = /** @class */ (function () {
    ...
    SegmentButton.prototype.render = function () {
        ...
        return (h(Host, { "aria-disabled": disabled ? 'true' : null, class: (_a = {},
                ...
                _a) }, h("button", { type: type, "aria-pressed": checked ? 'true' : 'false', class: "button-native", disabled: disabled }, h("span", { class: "button-inner" }, h("slot", null)), mode === 'md' && h("ion-ripple-effect", null)), h("div", { part: "indicator", class: {
