import { r as registerInstance, h, H as Host, e as getElement, d as createEvent, f as readTask, i as forceUpdate, w as writeTask } from './index-e23c3ffd.js';
import { b as getIonMode, c as config, i as isPlatform } from './ionic-global-fbc9a2ac.js';
import { c as clamp } from './helpers-5c745fbd.js';
import { t as transition } from './index-b60886e1.js';
    ...
    componentDidLoad() {
        {
            rIC(() => {
                ...
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-6a77b957.js').then(module => module.startStatusTap());
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-77712174.js').then(module => module.startInputShims(config));
                }
                if (config.getBoolean('hardwareBackButton', isHybrid)) {
                    import('./hardware-back-button-7b6ede21.js').then(module => module.startHardwareBackButton());
                }
                if (typeof window !== 'undefined') {
                    import('./index-120c8c20.js').then(module => module.startKeyboardAssist(window));
                }
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        this.gesture = (await import('./swipe-back-7b4b8b66.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
