...
const ionicGlobal = require('./ionic-global-2007c8fb.js');
const helpers = require('./helpers-9038d758.js');
const index$1$1 = require('./index-8e4efa70.js');
    ...
    componentDidLoad() {
        {
            rIC(() => {
                ...
                if (!ionicGlobal.config.getBoolean('_testing')) {
                    new Promise(function (resolve) { resolve(require('./tap-click-5f400d37.js')); }).then(module => module.startTapClick(ionicGlobal.config));
                }
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    new Promise(function (resolve) { resolve(require('./status-tap-f7a53634.js')); }).then(module => module.startStatusTap());
                }
                if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
                    new Promise(function (resolve) { resolve(require('./input-shims-866706a3.js')); }).then(module => module.startInputShims(ionicGlobal.config));
                }
                if (ionicGlobal.config.getBoolean('hardwareBackButton', isHybrid)) {
                    new Promise(function (resolve) { resolve(require('./hardware-back-button-2b00490e.js')); }).then(module => module.startHardwareBackButton());
                }
                if (typeof window !== 'undefined') {
                    new Promise(function (resolve) { resolve(require('./index-655d68c0.js')); }).then(module => module.startKeyboardAssist(window));
                }
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-fc891734.js')); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
