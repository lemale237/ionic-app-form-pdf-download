...
const animation = require('./animation-2a44c5d3.js');
const index$3 = require('./index-28ba2a42.js');
require('./hardware-back-button-2b00490e.js');
const overlays = require('./overlays-7c9a3ec9.js');
...
const Loading = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { onIonBackdropTap: this.onBackdropTap, tabindex: "-1", style: {
            ...
            }, class: Object.assign(Object.assign({}, theme.getClassMap(this.cssClass)), { [mode]: true, 'loading-translucent': this.translucent }) }, index.h("ion-backdrop", { visible: this.showBackdrop, tappable: this.backdropDismiss }), index.h("div", { class: "loading-wrapper", role: "dialog" }, spinner && (index.h("div", { class: "loading-spinner" }, index.h("ion-spinner", { name: spinner, "aria-hidden": "true" }))), message && index.h("div", { class: "loading-content", innerHTML: index$3.sanitizeDOMString(message) }))));
    }
